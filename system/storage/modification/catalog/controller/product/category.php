...
class ControllerProductCategory extends Controller {
 ...
 global $light_critical_mark;if($results)$light_critical_mark.='_sub'; // Lightning 
 ...
 global $light_critical_mark;if(empty($product_total))$light_critical_mark.='_zero'; // Lightning 
