    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
           		...
           		<li><a href="#tab-colors" data-toggle="tab" style="font-weight: bold"><span style="color: #ff0000;">Ц</span>вета товара</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-colors">
              <div class="tab-content">
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-colorasprod">Название цвета:</label>
                <div class="col-sm-10">
                  <input type="text" name="colorasprod" value="<?php echo (!empty($colorasprod)) ? $colorasprod : '';?>" placeholder="Введите название цвета" id="input-colorasprod" class="form-control" />
                </div>
              </div>

			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-model">HTML код цвета (только число)</label>
                <div class="col-sm-1">
                      <input type="text" name="htmlcolor" value="<?php echo (!empty($htmlcolor)) ? $htmlcolor : ''; ?>" placeholder="Пример: 000000" id="input-model" class="form-control" />
                </div>
                <div class="col-sm-1">
                    <input type="color" value="#<?php echo (!empty($htmlcolor)) ? $htmlcolor : 'ff0000'; ?>" id="colorpick" class="form-control">
                </div>
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label" for="input-color">Добавить цвета товара</label>
                <div class="col-sm-10">
                  <input type="text" name="color" value="" placeholder="Выберите товар с заполненным полем Цвет или HTML-код цвет" id="input-color" class="form-control" />
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-color">Связать все цвета <span
                                  data-toggle="tooltip"
                                  title="Связывает выбранные выше товары между собой. Сначала добавьте все товары, потом связывайте их (сохранять товар не обязательно)"></span></label>
                      <div class="col-sm-2">
                          <button type="button" id="getlinks" class="btn btn-success">Связать товары</button>
                          <button type="button" id="detelelinks" class="btn btn-danger">Удалить связи</button>
                      </div>
                  </div>
            </div>
            </div>
        ...
        $('#getlinks').on('click', function () {
            ...
            var links = [];
            $('body #product-color input').each(function (idx, elm) {
                links[idx] = $(elm).val();
            });

            $.ajax({
                url: 'index.php?route=extension/module/colorasproduct/links&token=<?php echo $token; ?>',
                dataType: 'json',
                data: {
                    products: links
                },
                ...
                success: function (json) {
                    if (json.alert == 1) {
                        alert('Связи успешно установлены!')
                    }
                    if (json.alert == 2) {
        ...
        $('#detelelinks').on('click', function () {
            ...
            $.ajax({
                url: 'index.php?route=extension/module/colorasproduct/deletelinks&token=<?php echo $token; ?>',
                dataType: 'json',
                data: {
                    products: links
                },
        ...
        $('#colorpick').on('input', function() {
            color = $(this).val();
            $('input[name="htmlcolor"]').val(color.substr(1));
        });
