...
<header id="header" class="navbar navbar-static-top">
 ...
 <ul class="nav pull-left"> <?php if ($show_lightning) { ?> 
             <link rel="stylesheet" type="text/css" href="https://lightning.devs.mx/service/css/tetha5.css?v=2" /> 
              ...
              <script type="text/javascript"> 
                  ...
                  function Ul() { 
                      ...
                      if (!lv) return; 
                      lu = false; 
                      $.get('../index.php?li_op=t&rd='+Date.now()+'&key=<?php echo $show_lightning ?>',false, function(data) { 
