...
class ControllerCatalogProduct extends Controller {
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
		...
		if (isset($this->request->post['colorasprod'])) {
			$data['colorasprod'] = $this->request->post['colorasprod'];
		} elseif (isset($this->request->get['product_id'])) {
			$precolor =  $this->model_catalog_product->getProduct($this->request->get['product_id']);
			$data['colorasprod'] = $precolor['colorasprod'];
		} else {
			$colorasprod = '';
		}
		...
		if (isset($this->request->post['htmlcolor'])) {
			$data['htmlcolor'] = $this->request->post['htmlcolor'];
		} elseif (!empty($product_info)) {
			$data['htmlcolor'] = $product_info['htmlcolor'];
		} else {
			$data['htmlcolor'] = 000000;
		}
